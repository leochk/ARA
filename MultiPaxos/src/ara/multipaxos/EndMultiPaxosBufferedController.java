...
public class EndMultiPaxosBufferedController extends AbstractEndMultiPaxosControler {

	public EndMultiPaxosBufferedController(String prefix) {
		super(prefix);
	}
	...
	public String getString() {
		...
		str.append(CommonState.r.getLastSeed() + ";" + Network.size() + ";" + prot.getNbMultiPaxosMessage() + ";"
				...
				+ ";" + prot.getProbaFauteTransitoire() + ";"+prot.getBufferN()+ "\n");
		return str.toString();
	}
	...
	public String getFormatFile() {
		return "seed;size;nbMsg;debit;latency;probaFF;probaFT;bufferN\n";
	}
	...
	public String getErrorString() {
		...
		str.append(CommonState.r.getLastSeed() + ";" + Network.size() + ";" + -1 + ";" + -1 + ";" + -1 + ";"
				+ prot.getProbaFauteFranche() + ";" + prot.getProbaFauteTransitoire() + ";"+prot.getBufferN()+"\n");
		return str.toString();
	}
